...
- **PE compat:** HS2PE / Pose Tools — Advanced Mode data in poses (all three games when plugin detected)

### Anim Browser

- **Shared code:** `src/AnimBrowser/`
- **HS2 only:** **Hover preview** (`AnimPreviewStage`, embedded rig + GL renderer)
- **KK/KKS:** No preview stage; otherwise same UI features
