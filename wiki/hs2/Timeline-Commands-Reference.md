...
1. [Input simulation](#input-simulation)
2. [Flow control](#flow-control)
3. [CopyScript](#copyscript)
4. [Screenshots](#screenshots)
5. [Studio / scene](#studio--scene)
6. [Variables & logic](#variables--logic)
7. [VNGE](#vnge-requires-modified-vnge)
8. [Other](#other)
9. [Adding new commands](#adding-new-commands-developers)
...
**Navigation:** [← Timeline](Timeline) · **Timeline commands** · [Next: SearchBarManager →](SearchBarManager)
