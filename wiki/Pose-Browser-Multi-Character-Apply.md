...
When group has saved relative positions and **Apply relative positions** is on, apply restores layout after poses (see [Pose groups](Pose-Browser-Groups)).
...
→ [Pose Browser](Pose-Browser) · [Pose groups](Pose-Browser-Groups)
