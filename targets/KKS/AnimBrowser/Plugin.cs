...
namespace HS2SandboxPlugin
{
    ...
    {
        public const string PluginGuid = "com.kks.sandbox.animbrowser";
        public const string PluginName = "KKS Sandbox - Anim Browser";
        ...
        private void Start()
        {
            ...
            gui.RegisterWindow(SandboxWindowKeys.AnimBrowser, gameObject.AddComponent<AnimBrowserWindow>(), initialVisible: false);
