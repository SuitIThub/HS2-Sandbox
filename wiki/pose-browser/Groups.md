...
![Pose group segment in the grid with header and member cards](images/pose-browser/pb-09-pose-group.png)

> Folder **A Night To Remember**: pose groups **10S1**–**10S3** with separate male/female cards (partner shown as silhouette); group **10S2** selected with group action bar at the bottom.
...
See also: [Thumbnails](Thumbnails) · [Multi-character apply](Multi-Character-Apply)

---

**Navigation:** [← Grid & selection](Grid-and-Selection) · [Pose Browser](Pose-Browser) · [Next: Multi-character apply →](Multi-Character-Apply)
