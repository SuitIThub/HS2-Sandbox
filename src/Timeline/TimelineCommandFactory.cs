    ...
    public static class TimelineCommandFactory
    {
        public static TimelineCommand Create(string typeId)
        {
            return typeId switch
            {
                ...
                "screenshot_alpha" => new ScreenshotAlphaModeCommand(),
                "screenshot_resolution" => new ScreenshotResolutionCommand(),
                "screenshot_save_path" => new ScreenshotSavePathCommand(),
                "screenshot_alt_path_var" => new ScreenshotAltPathVarCommand(),
                ...
                "get" => new GetVariableCommand(),
                "set_list" => new SetListCommand(),
                "calc" => new CalcCommand(),
                "if" => new IfCommand(),
                "list" => new ListCommand(),
                "label" => new LabelCommand(),
                "sub_timeline" => new SubTimelineCommand(),
                "sub_timeline_param" => new SubTimelineParamCommand(),
                ...
                "set_object_visible_by_name" => new SetObjectVisibleByNameCommand(),
                "replace_chara_card" => new ReplaceCharaCardCommand(),
                "load_coordinate_card" => new LoadCoordinateCardCommand(),
