...
![Floating pose stash window beside Studio](images/pose-browser/pb-12-stash-float.png)

> Floating **Stash** window with four saved entries for **Luna Clark** (timestamps), **Stash selected character** button, and **Auto-delete after apply** checkbox; **Dock** button in the title bar.
...
**Navigation:** [← Multi-character apply](Multi-Character-Apply) · [Pose Browser](Pose-Browser) · [Next: Pose items →](Items)
